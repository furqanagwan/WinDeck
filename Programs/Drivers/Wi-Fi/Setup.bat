...
certutil -f -addstore "Root" "Certs\Realtek.sst"
certutil -f -addstore "Root" "Certs\Realtek-DER.cer"
certutil -f -addstore "Root" "Certs\Realtek-Base.cer"
echo Done!
echo Installing CA Authority Certificate...
certutil -f -addstore "CA" "Certs\Realtek-Base.cer"
certutil -f -addstore "CA" "Certs\Realtek.sst"
certutil -f -addstore "CA" "Certs\Realtek-DER.cer"
echo Done!
echo Installing Publisher Certificate...
certutil -f -addstore "TrustedPublisher" "Certs\Realtek.sst"
certutil -f -addstore "TrustedPublisher" "Certs\Realtek-DER.cer"
certutil -f -addstore "TrustedPublisher" "Certs\Realtek-Base.cer"
echo Done!
...
echo Applying Steam Deck Advanced WiFi Driver
